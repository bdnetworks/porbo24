    ...
    <section className="border-b border-[#0f766e] bg-[#fcd2d471] dark:border-slate-700 dark:bg-slate-900">
     ...
     {/* home page top banner */}
      ...
      <div className="mx-auto px-4 py-5">
        <div className="grid grid-cols-1 gap-6 xl:grid-cols-[minmax(0,1fr)_500px]">
          {/* ================= LEFT: BIG IMAGE NEWS ================= */}
          <Link
              ...
              return (
                ...
                >
                  ...
                  <div className="order-2 pt-3">
                    ...
                    <h3 className="line-clamp-2 mb-2 text-[17px] font-bold leading-[1.45] text-[#111827] dark:text-slate-100">
                      {news.title}
                    </h3>
